...
import { AiFillCopy, AiFillDelete, AiOutlineCaretDown, AiOutlineExclamationCircle } from "react-icons/ai";
...
import { BsChevronLeft, BsFillCaretDownFill, BsFillCaretUpFill } from "react-icons/bs";
              ...
              <div className="flex text-xs sm:text-base w-full relative ">
                ...
                <div onClick={handleGlobal}  className="relative w-[10%] ">
                  ...
                  {showglobal && (
                    <div
                      ref={divglobal}
                      className="absolute flex flex-col gap-y-1 w-44  bg-slate-50 rounded-xl px-4 py-2 border-2 border-[#737475] top-8 -left-16"
                    >
              ...
              <div className="flex text-xs sm:text-base w-full  ">
                ...
                <div className="w-[15%] relative ">
                  ...
                  {showTenant && (
                    <div
                      ref={divTenant}
                      className="absolute flex flex-col gap-y-1 w-44  bg-slate-50 rounded-xl px-4 py-2 border-2 border-[#737475] -top-10 -left-"
                    >
                      <p className="text-sm text-[#737475] hover:bg-[#38bf67] px-2 cursor-pointer rounded-sm hover:text-white">
                        Send Message
                      </p>
            ...
            <div className="border bg-red-500]  shadow-md  flex flex-col  items-center  rounded-lg">
              <div className="flex text-xs sm:text-base w-full  ">
                ...
                <div className="w-[40%] relative ">
                  <p onClick={handleAdditional} className="text-xs cursor-pointer sm:text-base sm:py-2 font-bold  flex items-center justify-center text-center px-4 h-full">
                    Action
                  </p>
                  {showAdditional && (
                    <div
            ...
            <div
                ...
                >
                  ...
                  {showSort && (
                    <div
                      ref={divSort}
                      className="absolute flex flex-col gap-y-1 px-4 w-44 right-0 bg-slate-50  rounded-xl  py-2 border-2 border-[#737475] top-8"
                    >
                      <p className="text-sm text-[#737475] hover:bg-[#38bf67] px-2 cursor-pointer rounded-sm hover:text-white">
                        Open
                      </p>
